...
async def upload_lab_report(
    ...
    background_tasks.add_task(_process_report_ai, report.report_id, patient_id, db)

    return report


async def _process_report_ai(report_id: uuid.UUID, patient_id: str, db: AsyncSession):
    try:
